    ...
    <div class="row justify-content-center">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                <img src="assets/img/skp_pic.jpeg" alt="login" class="col-lg-12 d-none d-lg-block">    
                </div>
        ...
        <div class="p-2">
            <div class="text-center">
                <img src="assets/img/unp2.png" alt="logo" class="logo">
                 <h1 class="h4 text-gray-900 mb-4">Sasaran Kerja Pegawai</h1>
            </div>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                <div class="form-group">
                    <input type="number" name='nip' class="form-control form-control-user" pattern="[A-Za-z0-9]{}" placeholder="Masukan NIP sebagai Username">
                </div>
                <div class="form-group">
            ...
            <div class="text-center">
                Belum punya akun?<a class="small" href="ba.php"> Daftar disini!</a>
            </div>
            <nav class="login-card-footer-nav mt-5">
                <a href="">Terms of use |</a>
                <a href="">Privacy policy</a>
                <a href="https://victoreric.info">VictorEric</a>
            </nav>
...
<?php
	...
	$query="SELECT * FROM login WHERE nip='$nip' AND password='$pass'";
	...
	if ($cek==1 ) {
		...
		if($_SESSION['level']=='1' && $_SESSION['active']=='Y'){
			...
			session_destroy();
			echo "<script> alert ('User dan Pasword belum diaktifkan..! Hubungi Sub Bagian Kepegawaian'); window.location='index.php'; </script>" ;
		}
	}
	else{
 		echo "<script> alert ('User dan Pasword tidak terdaftar. Hubungi Sub Bagian Kepegawaian.'); window.location='index.php'; </script>" ;
	}
}
?>
